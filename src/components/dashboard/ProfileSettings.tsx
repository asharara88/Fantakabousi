...
const ProfileSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Update your account and health preferences</p>
            </div>
          </div>
        </div>
        
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2 px-3 py-1 bg-neon-green/20 text-neon-green rounded-full text-sm font-medium">
              ...
              <motion.button
                ...
                className={`w-full flex items-center space-x-3 p-4 rounded-xl transition-all duration-200 ${
                  activeSection === section.id
                    ? 'bg-gradient-to-r from-blue-light to-blue-medium text-white border border-blue-light/30'
            ...
            >
              ...
              {(activeSection === 'profile' || activeSection === 'health') && (
                <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-border">
                  <button className="px-6 py-3 border border-border text-muted-foreground font-medium rounded-xl hover:bg-muted/50 transition-colors">
                    Cancel
                  </button>
                  <motion.button
                    ...
                    onClick={handleSave}
                    disabled={loading}
                    className="px-6 py-3 bg-gradient-to-r from-blue-light to-blue-medium text-white font-medium rounded-xl hover:opacity-90 disabled:opacity-50 transition-all duration-200 flex items-center space-x-2"
                  >
                    {loading ? (
      ...
      {/* Danger Zone */}
      <div className="bg-card border border-red-500/30 rounded-xl p-8 shadow-sm">
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
          ...
          <div className="flex space-x-4">
            <button className="px-6 py-3 border-2 border-red-500 text-red-500 font-medium rounded-xl hover:bg-red-500/10 transition-colors">
              Delete Account
            </button>
            <button 
