    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground font-inter">Daily Insights</h2>
            <p className="text-muted-foreground font-inter">Your personalized health recommendations</p>
          </div>
        </div>
