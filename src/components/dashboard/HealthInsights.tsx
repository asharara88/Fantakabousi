  ...
  const insights = [
    {
      ...
      message: 'Congratulations! You\'ve maintained 8+ hours of sleep for 7 consecutive days. Your recovery metrics show a 15% improvement.',
    ...
    },
    {
      ...
      message: 'Based on your sleep data, consider shifting your bedtime 15 minutes earlier to align with your natural circadian rhythm.',
