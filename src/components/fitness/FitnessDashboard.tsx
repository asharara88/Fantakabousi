...
import BiometricChart from '../dashboard/BiometricChart';
import SupplementStack from '../dashboard/SupplementStack';
import AICoachEnhanced from '../dashboard/AICoachEnhanced';
import HealthDashboard from '../dashboard/HealthDashboard';
import NutritionDashboard from '../nutrition/NutritionDashboard';
import ProfileSettingsEnhanced from '../dashboard/ProfileSettingsEnhanced';
