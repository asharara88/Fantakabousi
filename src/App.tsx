...
import BiometricChart from './components/dashboard/BiometricChart';
import SupplementStack from './components/dashboard/SupplementStack';
...
import ProfileSettingsEnhanced from './components/dashboard/ProfileSettingsEnhanced';
